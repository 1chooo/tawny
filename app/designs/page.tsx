          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between gap-3">
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <button aria-label={`Preview ${design.title}`} className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-white/20 transition-colors">
        ...
        <BlurFade delay={0.05}>
          <div className="mb-12">
            ...
            <p className="mt-3 text-muted-foreground max-w-lg text-pretty leading-relaxed">
              Browse all {designs.length} templates. Filter by category or switch between layout views.
            </p>
          </div>
        </BlurFade>
