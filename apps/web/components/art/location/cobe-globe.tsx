...
import type { LocationPoint } from "@/lib/art/locations";
    ...
    <div className="mx-auto w-full max-w-lg">
      ...
      >
        ...
        {locations.map((point) => (
          <div
            key={point.id}
            className="bg-art-ink text-art-paper pointer-events-none absolute rounded px-2 py-0.5 text-xs font-medium whitespace-nowrap"
            style={{
