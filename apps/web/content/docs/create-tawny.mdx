---
title: create-tawny
description: Scaffold an Art, Dev, or Link project with the create-tawny CLI.
---
...
<Callout type="tip" title="Tip">
  Preview the same templates live on the site before you scaffold: [Art](/designs/art), [Dev](/designs/dev), and [Link](/designs/link).
</Callout>
