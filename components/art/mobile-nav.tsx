  ...
  return (
    <div className="md:hidden">
      <button
        ...
        className="text-art-bento-ink flex min-h-11 min-w-11 items-center justify-center"
      >
      ...
      {open ? (
        <nav
          id="mobile-nav-panel"
          className="border-art-bento-ink/20 absolute inset-x-0 top-full border-b bg-art-bento-bg px-4 py-4 shadow-sm"
        >
