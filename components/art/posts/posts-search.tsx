  ...
  return (
    <label className="block">
      ...
      <input
        ...
        autoComplete="off"
        spellCheck={false}
        className="border-art-border bg-art-surface text-art-ink placeholder:text-art-ink-muted focus:border-art-accent focus:ring-art-accent/30 w-full rounded-lg border px-4 py-2.5 text-sm outline-none focus:ring-2 md:text-base"
      />
    </label>
  );
}
